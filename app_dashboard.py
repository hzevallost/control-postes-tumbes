...
# Indicadores principales como botones. El detalle se abre en una ventana modal.
# Se muestran cinco indicadores para darles mayor ancho y mejorar su legibilidad.
st.markdown(
    """
    <style>
