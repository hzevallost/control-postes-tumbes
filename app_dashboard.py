...
if lat_col and lon_col:
    ...
    if len(map_df):
        ...
        # scatter_mapbox + open-street-map resulta más estable en Streamlit Cloud
        # para la carga de teselas OSM que scatter_map en algunos navegadores.
        fig_map = px.scatter_mapbox(
            ...
            hover_data=hover,
            center=map_center,
            zoom=15 if len(map_df) == 1 else 12,
            height=480,
        )
